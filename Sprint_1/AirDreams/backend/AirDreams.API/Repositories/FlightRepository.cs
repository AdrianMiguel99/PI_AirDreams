    ...
    public class FlightRepository : IFlightRepository
    {
        ...
        )
        {
            ...
            SELECT
                    ...
                    r.porcentageMultiplier AS PorcentageMultiplier,
...

{
        ...
        public async Task<IEnumerable<dynamic>> SearchFlightsByDestinationAsync(
            string destination,
            DateTime earliestDeparture,
            DateTime latestDeparture,
            int quantityOfPassengers
        ...
        public async Task<IEnumerable<dynamic>> SearchFlightsByOriginAsync(
            string origin,
            DateTime earliestDeparture,
            DateTime latestDeparture,
            int quantityOfPassengers
