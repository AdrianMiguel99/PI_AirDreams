...
-- Paso 2: Alterar todas las columnas involucradas a VARCHAR(50) para que coincidan
ALTER TABLE Flight ALTER COLUMN numberFlight VARCHAR(50) NOT NULL;
ALTER TABLE Tiene ALTER COLUMN flightNumber VARCHAR(50) NOT NULL;
ALTER TABLE CheckIn ALTER COLUMN flightNumber VARCHAR(50) NOT NULL;
