...
[TestFixture]
public class DeleteMainAdminTests
{
    [Test]
    public void DeleteUserAsync_WhenDeletingMainAdmin_ShouldThrowInvalidOperationException()
    {
        ...
        repositoryMock
            ...
            {
                EmployeeID = 2,
                EmailInternalUser = "admin3@air.com",
                IsAdmin = true
            });
