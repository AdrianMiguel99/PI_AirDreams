...
[TestFixture]
public class ConfirmCancellationExpiredTokenTests
{
    [Test]
    public void ConfirmCancellationAsync_WhenTokenIsExpired_ShouldThrowInvalidOperationException()
    {
        ...
        repositoryMock
            ...
            .ReturnsAsync(("TXN-TEST", false, DateTime.UtcNow.AddHours(-1)));
